...
export const MS2026_FANTASY_OFFICIAL_GAME_DAYS: Ms2026FantasyOfficialGameDaySeed[] = [
  ...
  },
  {
    ...
    matches: [
      { startAt: "2026-05-21T14:20:00.000Z", home: "LAT", away: "FIN", group: "A", homeScore: 1, awayScore: 7 },
      { startAt: "2026-05-21T14:20:00.000Z", home: "CAN", away: "NOR", group: "B", homeScore: 6, awayScore: 5 },
      { startAt: "2026-05-21T18:20:00.000Z", home: "SUI", away: "GBR", group: "A", homeScore: 4, awayScore: 1 },
      { startAt: "2026-05-21T18:20:00.000Z", home: "DEN", away: "SVK", group: "B", homeScore: 1, awayScore: 5 },
    ],
  },
  {
    slug: "2026-05-22",
    ...
    matches: [
      { startAt: "2026-05-22T14:20:00.000Z", home: "GER", away: "HUN", group: "A", homeScore: 6, awayScore: 2 },
      { startAt: "2026-05-22T14:20:00.000Z", home: "CAN", away: "SLO", group: "B", homeScore: 3, awayScore: 1 },
      { startAt: "2026-05-22T18:20:00.000Z", home: "FIN", away: "GBR", group: "A", homeScore: 4, awayScore: 0 },
      { startAt: "2026-05-22T18:20:00.000Z", home: "SWE", away: "ITA", group: "B", homeScore: 3, awayScore: 0 },
    ],
  },
  {
    slug: "2026-05-23",
  ...
  },
  {
    ...
    matches: [
      { startAt: "2026-05-25T14:20:00.000Z", home: "USA", away: "HUN", group: "A", homeScore: 7, awayScore: 3 },
      { startAt: "2026-05-25T14:20:00.000Z", home: "CZE", away: "NOR", group: "B", homeScore: 1, awayScore: 4 },
      { startAt: "2026-05-25T18:20:00.000Z", home: "GER", away: "GBR", group: "A", homeScore: 6, awayScore: 3 },
      { startAt: "2026-05-25T18:20:00.000Z", home: "SLO", away: "ITA", group: "B", homeScore: 5, awayScore: 1 },
    ],
  },
  {
    slug: "2026-05-26",
    ...
    matches: [
      { startAt: "2026-05-26T10:20:00.000Z", home: "HUN", away: "LAT", group: "A", homeScore: 1, awayScore: 8 },
      { startAt: "2026-05-26T10:20:00.000Z", home: "NOR", away: "DEN", group: "B", homeScore: 4, awayScore: 3 },
      { startAt: "2026-05-26T14:20:00.000Z", home: "USA", away: "AUT", group: "A", homeScore: 4, awayScore: 1 },
      { startAt: "2026-05-26T14:20:00.000Z", home: "SWE", away: "SVK", group: "B", homeScore: 4, awayScore: 2 },
      { startAt: "2026-05-26T18:20:00.000Z", home: "SUI", away: "FIN", group: "A", homeScore: 4, awayScore: 2 },
      { startAt: "2026-05-26T18:20:00.000Z", home: "CZE", away: "CAN", group: "B", homeScore: 2, awayScore: 3 },
    ],
  },
  {
    slug: "2026-05-27",
  ...
  },
  {
    ...
    matches: [
      {
        startAt: "2026-05-28T14:20:00.000Z",
        phase: "Čtvrtfinále",
        home: "FIN",
        away: "CZE",
        homeScore: 4,
        awayScore: 1,
        label: "Čtvrtfinále (Swiss Life Arena, Zürich)",
      },
      {
        startAt: "2026-05-28T14:20:00.000Z",
        phase: "Čtvrtfinále",
        ...
        homeScore: 4,
        awayScore: 0,
        label: "Čtvrtfinále (BCF Arena, Fribourg)",
      },
      {
        startAt: "2026-05-28T18:20:00.000Z",
        phase: "Čtvrtfinále",
        home: "NOR",
        away: "LAT",
        homeScore: 2,
