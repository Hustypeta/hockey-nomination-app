...
/**
 * Celostránkové „Frozen Arena“ pozadí (gradienty + šum, bez fotky).
 * Fotka arény je jen v hero na homepage — viz `LandingContent`.
 */
export function FrozenArenaAmbientBackground({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[min(38vh,320px)] bg-gradient-to-t from-[#05060f] via-[#05060f]/92 to-transparent" />
      <div
