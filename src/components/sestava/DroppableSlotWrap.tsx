...
export function DroppableSlotWrap({
  ...
  /** Vyplní rodiče (slot na šabloně ledu). */
  fill?: boolean;
  ...
  const overCls = lightSurface
    ...
    : "jersey-slot-dnd-highlight bg-[#c8102e]/10 ring-2 ring-[#c8102e]/85 ring-offset-2 ring-offset-[#08080f] shadow-[0_0_36px_rgba(200,16,46,0.35),0_0_52px_rgba(0,48,135,0.15)]";
  ...
  return (
    <div
      ...
      className={`
        ${className}
        min-w-0 w-full transition-[box-shadow,background-color] duration-200
        ${fill ? "h-full min-h-0 touch-manipulation rounded-none py-0" : "touch-pan-y rounded-2xl py-0.5 sm:py-0"}
        ${isOver ? overCls : ""}
      `}
    >
      {content}
